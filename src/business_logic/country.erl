...
%% API
-export([happiness_score_json/1,happiness_json/1,get_happiness/2, set_happiness/3, set_total/3, get_total/2, get_score/2, decrease_happiness/2, increase_happiness/2, increase_total/2]).
